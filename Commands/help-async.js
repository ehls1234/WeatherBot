module.exports = {
    ...
    async execute(message){
        ...
        **명령어 :  !오늘날씨 <시/도>**
        ...
        최소 온도, 최대 온도 :  예보상 온도 입니다.

        자외선 지수(UVI) : 현재 '시간'의 자외선 지수 입니다.

        현재 온도, 체감 온도, 습도 : 현재 '시간'의 온도와 습도 입니다.

        강수 확률, 강수량, 적설량 :  예보상 확률, 강수량, 적설량 입니다.
        ...
        **명령어 :  !내일날씨 <시/도>**
        ...
        자외선 지수(UVI) : 예보상 온도 자외선 지수 입니다.

        현재 온도, 체감 온도, 습도 : 예보상 온도 온도와 습도 입니다.
